...
async function renderBookmarks() {
    ...
    if (bookmarks !== null) {
        bookmarks.forEach(bookmark => {
            ...
            else if (bookmark.Categorie == trierCategorie) {
                $("#content").append(renderBookmark(bookmark));
            }
        ...
        $(".selection").on("click", function () {
            // Lorsque je clique sur une catégorie, je veux reload les bookmarks et les mettrent dans ma variable global
            ...
            <div class="bookmarkRow" bookmark_id=${bookmark.Id}">
                <div class="bookmarkContainer">
                    ...
                    <img src="https://www.google.com/s2/favicons?sz=32&domain=${bookmark.Url}" class="appLogo">
                        ...
                        <a href="${bookmark.Url}"  target="_blank"><span class="bookmarkCategorie">${bookmark.Categorie}</span></a>
                    </div>
                </div>  
            </div>   
            <br>
...
function renderCategorie(categorie, selectedCategory = false) {
